  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-background-primary">
      ...
      <div className="relative z-20 flex h-full flex-col items-center justify-center px-4 text-center text-white md:items-start md:pl-40 md:text-left lg:pl-60">
        {/* Trust Badge */}
        <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 bg-accent-teal/20 border border-accent-teal/40 rounded-full backdrop-blur-sm">
        ...
        <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:gap-6">
          <Link
            href="/contact"
            className="inline-block rounded-xl bg-gradient-to-r from-accent-teal via-accent-cyan to-accent-teal-light px-8 py-4 text-center text-lg font-bold text-white shadow-xl shadow-accent-teal/30 transition-all duration-300 hover:brightness-110 hover:scale-105"
          >
            BESPLATNA KONZULTACIJA
          </Link>
          <Button
            variant="outline"
            className="h-auto rounded-xl border-2 border-white bg-transparent px-8 py-4 text-lg font-semibold text-white transition-all duration-300 hover:bg-white hover:text-background-primary hover:scale-105"
          >
            SAZNAJ VIŠE
          </Button>
        </div>
